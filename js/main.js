...
// Fonction sécurisée pour charger le contenu des fenêtres
    ...
    try {
        switch (type) {
            ...
            case 'courses':
                    ...
                    <div class="courses-list">
                        <div class="course-item" data-year="bts">
                            <div class="course-header">
                                ...
                                <button class="toggle-btn" aria-label="Afficher/Masquer">▶</button>
                            </div>
                ...
                `;
                setupCourseInteractions(container);
                break;
            ...
            default:
                console.warn(`Type de fenêtre non reconnu: ${type}`);
                return;
        }
        ...
        console.error(`Erreur lors du chargement du contenu pour ${type}:`, error);
        content.innerHTML = '<p>Une erreur est survenue lors du chargement du contenu.</p>';
    }
}

// Fonction optimisée pour les interactions des cours
function setupCourseInteractions(container) {
